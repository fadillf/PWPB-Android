    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.btn_move_activity:
                Intent moveIntent = new Intent(MainMenuActivity.this, MoveActivity.class);
                startActivity(moveIntent);
                break;

            case R.id.btn_move_with_data_activity:
                Intent moveWithDataIntent = new Intent(MainMenuActivity.this, MoveWithDataActivity.class);
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_NAME, "Fadillah Fadlurahman");
            ...
            case R.id.btn_move_activity_object:
                ...
                mPerson.setName("Fadillah Fadlurahman");
                mPerson.setAge(17);
                mPerson.setEmail("fadillahfadlurrahman@gmail.com");
                mPerson.setCity("Bandung");

                Intent moveWithObjectIntent = new Intent(MainMenuActivity.this, MoveWithObjectActivity.class);
                moveWithObjectIntent.putExtra(MoveWithObjectActivity.EXTRA_PERSON, mPerson);
                startActivity(moveWithObjectIntent);
                break;

            case R.id.btn_dial_number:
                String phoneNumber = "085156268056";
                Intent dialPhoneIntent = new Intent(Intent.ACTION_DIAL, Uri.parse("tel:" + phoneNumber));
                startActivity(dialPhoneIntent);
                break;

            case R.id.btn_move_for_result:
                Intent moveForResultIntent = new Intent(MainMenuActivity.this, MoveForResultActivity.class);
